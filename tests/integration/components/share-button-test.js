...
module('Integration | Component | share-button', function (hooks) {
  ...
  test('basic usage of button', async function (assert) {
  ...
  test('it support passing @text', async function (assert) {
    await render(hbs`<ShareButton @text='Hello'>Tweet This!</ShareButton>`);
    assert.strictEqual(this.tweetParam('text'), 'Hello');
  });
  test('it suppports the hashtags', async function (assert) {
    await render(
